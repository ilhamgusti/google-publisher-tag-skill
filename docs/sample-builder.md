The Google Publisher Tag (GPT) sample builder is a tool for creating custom, interactive GPT test pages. For more information, see the [Overview](https://developers.google.com/publisher-tag/sample-builder#overview) section.

## Loading...

<iframe id="builder" class="fixed-size" loading="lazy"></iframe>
...
the [GPT Reference](https://developers.google.com/publisher-tag/reference).
